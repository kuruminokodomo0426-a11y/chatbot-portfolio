      ...
      >
        ...
        {messages.map((m, i) => (
          <div
            ...
            className={
              m.role === "user"
                ? "ml-8 rounded-2xl border border-teal-600/20 bg-teal-500 px-4 py-3 text-base font-semibold text-white shadow-sm shadow-teal-600/20"
                : "mr-8 rounded-2xl border border-slate-200 bg-slate-50 px-4 py-3 text-base font-medium leading-relaxed text-slate-800"
            }
          >
